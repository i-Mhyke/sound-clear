...
var W3Module = (function () {
  if (window.Worker) {
    ...
    let worker = new Worker('assets/vendors/WebM-MP3-master/process.js');
    let options = {};
    ...
    const convertWebmToMP3 = function (webmBlob, decomposition = false) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        let blob =
          webmBlob.type === 'audio/ogg'
            ? webmBlob
            : new Blob([webmBlob], { type: 'audio/ogg; codecs=opus' });
        ...
        const readEventEBML = function (evt) {
          ...
          chunkReaderBlock(0, options.header, blob);
